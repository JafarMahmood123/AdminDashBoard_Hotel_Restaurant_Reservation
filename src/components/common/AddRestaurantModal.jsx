...
import '../../assets/styles/AddRestaurantModal.css';
import MapSelector from './MapSelector';

const AddRestaurantModal = ({ onClose, onRestaurantAdded }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
        ...
        await ApiService.addRestaurant(newRestaurant);
        onRestaurantAdded();
        onClose();

    } catch(err) {
        const errorMessage = err.response?.data?.message || err.message || 'Failed to add restaurant.';
    ...
    <div className="modal-overlay">
      <div className="modal-content">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <button type="submit" className="add-restaurant-button" disabled={isSubmitting}>
